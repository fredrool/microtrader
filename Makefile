...
# AWS ECR Settings
DOCKER_REGISTRY ?= 305261792510.dkr.ecr.us-east-2.amazonaws.com
AWS_ACCOUNT_ID ?= 305261792510
DOCKER_LOGIN_EXPRESSION := eval $$(aws ecr get-login --region us-east-2 --registry-ids $(AWS_ACCOUNT_ID) --no-include-email)
